                ...
                <form onSubmit={handleSubmit(onSubmit)} className='space-y-5'>
                    ...
                    <div className='create-job-flex'>
                        ...
                        <div className='lg:w-1/2 w-full '>
                            ...
                            <input type="text" placeholder="New York" {...register("jobLocation")} className='create-job-input' />
                        </div>
                    </div>
                    ...
                    <div className='create-job-flex'>
                        <div className='lg:w-1/2 w-full '>
                            ...
                            <input type="date" placeholder="2023-08-17" {...register("postingDate")} className='create-job-input' />
                        </div>
                        <div className='lg:w-1/2 w-full '>
                            ...
                            <select {...register("experienceLevel")} className='create-job-input'>
                                ...
                                <option value="Wrok remotely">Work remotely</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div className='w-full '>
                        ...
                        <textarea {...register("description")} className='w-full pl-3 py-1.5 focus:outline-none' rows={6} placeholder='Add a  description'></textarea>
                    </div>
                    
                    <div>
                        <label className='block mb-2 text-lg'>Job posted by</label>
                        <input type="email" placeholder="Your E-mail " {...register("postedBy")} className='create-job-input' />

                    </div>

                    <input type="submit" className='py-2 block mt-12 bg-blue text-white font-semibold px-8 rounded-sm cursor-pointer ' />
