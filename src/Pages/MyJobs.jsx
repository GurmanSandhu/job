...
const MyJobs = () => {
    ...
    useEffect(() => {
        setIsLoading(true)
        fetch("http://localhost:3000/myJobs/gurmansandhu486@gmail.com")
    ...
    const handleDelete=(id)=>{
        ...
        fetch('http://localhost:3000/job/$_id',{
            method: "DELETE"
        }).then (res=>res.json).then(data=>{
                ...
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
                    <div className="rounded-t mb-0 px-4 py-3 border-0">
                        <div className="flex flex-wrap items-center">
                            ...
                            <div className="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
                                <Link to="/post-job"><button className="bg-indigo-500 text-white active:bg-indigo-600 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">Post new job</button>
                                </Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="block w-full overflow-x-auto">
                        <table className="items-center bg-transparent w-full border-collapse ">
                            ...
                            {
                                isLoading ? (<div className='flex items-center justify-centerh-20'><p>Loading...</p></div>):(<tbody>
                                    {
